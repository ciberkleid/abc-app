...
```json
{
  "bsGitBranch" : "main",
  "projectName" : "abc-app",
  "repositoryPrefix" : "docker.io/ciberkleid736"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->abc-app]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->docker.io/ciberkleid...(truncated)]
